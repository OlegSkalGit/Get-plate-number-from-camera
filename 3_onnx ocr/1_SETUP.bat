...
".venv\Scripts\python.exe" -c "import cv2, numpy, PIL, onnxruntime, yaml, fast_alpr" >nul 2>nul
if %ERRORLEVEL% neq 0 (
    echo Необхідні бібліотеки НЕ знайдено. Встановлюємо...
    echo (Завантаження PyTorch та OpenCV може зайняти 1-3 хвилини)
    echo.
    ".venv\Scripts\python.exe" -m pip install --upgrade pip
    ".venv\Scripts\python.exe" -m pip install opencv-python numpy pillow onnxruntime pyyaml fast-alpr fast-plate-ocr
    if !ERRORLEVEL! neq 0 (
        echo.
        echo ===============================================================================================
